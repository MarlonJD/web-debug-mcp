...
- Explicit `interactiveElements` capture that gives an agent a bounded, visible/actionable UI map with live-validated locators, state, and geometry; it is a discovery aid, not a qualification oracle.
