...
The public README remains the installation and user-facing overview. Durable behavior is now split because setup/readiness, structured MCP output, session lifecycle, browser actions, compatibility, and qualification have independent change triggers.
