...
| React/Vite adapter | `npm run typecheck` | `npm run smoke:react-vite` | Component tree, hook state, source breakpoint, screenshot, and scenario verification | Requires Vite dependencies and an explicit Chromium executable | Platform Engineering; React bridge or Vite fixture change |
