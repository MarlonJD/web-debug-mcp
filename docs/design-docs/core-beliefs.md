...
| --- | --- | --- | --- |
| One MCP facade, optional internal adapters | Tool catalogs are part of agent context and should not duplicate overlapping debug servers | Codex sees a small stable workflow while framework support grows behind interfaces | MCP routing tests |
